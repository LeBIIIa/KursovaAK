...
main(int argc, char *argv[])
{
	...
	*/
	...
	if (strcmp(opcode, "add") && strcmp(opcode, "nand") &&
		...
		strcmp(opcode, ".fill") && strcmp(opcode, "sl") ) {
	...
	if (!strcmp(opcode, "add") || !strcmp(opcode, "nand") ||
		!strcmp(opcode, "lw")  || !strcmp(opcode, "sw")   ||
		!strcmp(opcode, "beq") || !strcmp(opcode, "jalr") ||
		!strcmp(opcode, "mul")  || !strcmp(opcode, "sl") ) {
	    testRegArg(arg0);
	    testRegArg(arg1);
	}
	if (!strcmp(opcode, "add") || !strcmp(opcode, "nand") ||
    ...
    for (address=0; readAndParse(inFilePtr, label, opcode, arg0, arg1, arg2);
		...
		if (!strcmp(opcode, "add")) {
			...
			num = (MUL << 22) | (atoi(arg0) << 19) | (atoi(arg1) << 16)
				| atoi(arg2);
		} else if(!strcmp(opcode, "sl")){
			num = (SL << 22) | (atoi(arg0) << 19) | (atoi(arg1) << 16)
				| atoi(arg2);
